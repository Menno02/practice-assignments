...
class Element:
    ...
    def __init__(self, node1, node2):
        ...
        alpha = np.arctan2(self.nodes[0].z - self.nodes[1].z, self.nodes[1].x - self.nodes[0].x)
    ...
    def stiffness(self):
        ...
        k[0, 0] = k[3, 3] = EA / L
        k[0, 3] = k[3, 0] = -EA / L
        k[1, 1] = k[4, 4] = 12.0 * EI / L**3
        k[1, 4] = k[4, 1] = -12.0 * EI / L**3
        k[1, 2] = k[2, 1] = k[5, 1] = k[1, 5] = -6.0 * EI / L**2
        k[2, 2] = k[5, 5] = 4.0 * EI / L
        k[4, 2] = k[2, 4] = k[5, 4] = k[4, 5] = 6.0 * EI / L**2
        k[5, 2] = k[2, 5] = 2.0 * EI / L
